    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-12 m-auto">
                <!-- Form Pendaftaran -->
                <form method="POST" action="{{ route('confirm') }}" style="font-family: comic-sans-bold;" class="p-4 shadow p-3 mb-5 bg-body rounded border border-5 bordersecondary position-absolute start-50 top-50 translate-middle">
                @csrf
                    <h3 class="pb-3">Form Pendaftaran</h3>
                        ...
                        <div class="text-center mt-3">
                            ...
                            ?>
                            <a href="{{ url('/') }}" class="btn btn-dark col-sm-2">Batal</a>
                        </div>
                        <!-- End Button -->
                </form>
            </div>
